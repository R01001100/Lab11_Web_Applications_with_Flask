...
def register():
    ...
    if form.validate_on_submit():
        # Data & Obs #13: Prevent Duplicate Email Registration
...
def login():
    ...
    # Data & Obs #18: Print Form Validation Result
    (
...
@login_required
def students():
    # Data & Obs #6: Sort Students Alphabetically Before Displaying
...
# Data & Obs #9: Add 404 Error Handler to app.py
